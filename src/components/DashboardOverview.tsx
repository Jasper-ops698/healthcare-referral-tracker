...
import type { typeof Translations } from '@/i18n/translations';
import {
...
function translateActivityDescription(description: string, t: (key: typeof Translations, vars?: Record<string, string>) => string): string {
