...
import { handleCreateUser, handleListUsers, handleResendWelcome, handleUpdateProfile, handleAdminUpdateUser, handleGetMe, handleListCollectorStations } from '../controllers/userController.js';
...
router.get('/stations', authenticateJWT, handleListCollectorStations);
